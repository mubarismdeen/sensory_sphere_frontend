import 'package:admin/pages/login/signup.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    var we = MediaQuery.of(context).size.width /2;
    var he = MediaQuery.of(context).size.height/2;
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Expanded(
            ...
            child: SizedBox(
              ...
              child: Column(
                children: <Widget>[
                  FadeAnimation(delay: 0.8,child: Image.asset("name")),
                  FadeAnimation(
                    delay: 1,
                    child: Container(
